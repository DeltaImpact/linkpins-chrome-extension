...
module.exports = !__webpack_require__(8) && !__webpack_require__(4)(function () {
  return Object.defineProperty(__webpack_require__(81)('div'), 'a', { get: function get() {
      return 7;
    } }).a != 7;
});
...
var _symbolObservable = __webpack_require__(382);
...
var _baseGetTag = __webpack_require__(374);

var _baseGetTag2 = _interopRequireDefault(_baseGetTag);

var _getPrototype = __webpack_require__(379);

var _getPrototype2 = _interopRequireDefault(_getPrototype);

var _isObjectLike = __webpack_require__(381);
...
var _root = __webpack_require__(375);
...
var INCREMENT_BACKGROUND_COUNTER = exports.INCREMENT_BACKGROUND_COUNTER = 'INCREMENT_BACKGROUND_COUNTER';
var DECREMENT_BACKGROUND_COUNTER = exports.DECREMENT_BACKGROUND_COUNTER = 'DECREMENT_BACKGROUND_COUNTER';
var INCREMENT_UI_COUNTER = exports.INCREMENT_UI_COUNTER = 'INCREMENT_UI_COUNTER';
var DECREMENT_UI_COUNTER = exports.DECREMENT_UI_COUNTER = 'DECREMENT_UI_COUNTER';
...
var _bindActionCreators = __webpack_require__(385);
...
// @@match logic
__webpack_require__(72)('match', 1, function (defined, MATCH, $match, maybeCallNative) {
  return [
...
// @@replace logic
__webpack_require__(72)('replace', 2, function (defined, REPLACE, $replace, maybeCallNative) {
  return [
...
// @@search logic
__webpack_require__(72)('search', 1, function (defined, SEARCH, $search, maybeCallNative) {
  return [
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(61), __webpack_require__(150)(module)))
...
var _Symbol2 = __webpack_require__(153);

var _Symbol3 = _interopRequireDefault(_Symbol2);

var _getRawTag = __webpack_require__(377);

var _getRawTag2 = _interopRequireDefault(_getRawTag);

var _objectToString = __webpack_require__(378);
...
var _freeGlobal = __webpack_require__(376);
...
var _overArg = __webpack_require__(380);
...
var _ponyfill = __webpack_require__(383);
...
var _backgroundStore = __webpack_require__(388);
...
var _uiStore = __webpack_require__(389);
...
exports.incrementBackgroundCounter = incrementBackgroundCounter;
exports.decrementBackgroundCounter = decrementBackgroundCounter;
exports.incrementUICounter = incrementUICounter;
exports.decrementUICounter = decrementUICounter;

var _constants = __webpack_require__(157);

function incrementBackgroundCounter() {
    return { type: _constants.INCREMENT_BACKGROUND_COUNTER };
}

function decrementBackgroundCounter() {
    return { type: _constants.DECREMENT_BACKGROUND_COUNTER };
}

function incrementUICounter(_ref) {
    var value = _ref.value;

    return {
        type: _constants.INCREMENT_UI_COUNTER,
        value: value
    };
}

function decrementUICounter(_ref2) {
    var value = _ref2.value;

    return {
        type: _constants.DECREMENT_UI_COUNTER,
        value: value
    };
}
...
setInterval(function () {
    _store2.default.dispatch(Math.random() >= 0.5 ? (0, _actions.incrementBackgroundCounter)() : (0, _actions.decrementBackgroundCounter)());
}, 1000);
...
var _reduxWebext = __webpack_require__(387);
...
exports.default = (0, _reduxWebext.createBackgroundStore)({
    store: store,
    actions: {
        INCREMENT_UI_COUNTER: _actions.incrementUICounter,
        DECREMENT_UI_COUNTER: _actions.decrementUICounter
    }
});
...
exports.default = (0, _redux.combineReducers)({
    backgroundCounter: createCounterReducer(_constants.INCREMENT_BACKGROUND_COUNTER, _constants.DECREMENT_BACKGROUND_COUNTER),
    uiCounter: createCounterReducer(_constants.INCREMENT_UI_COUNTER, _constants.DECREMENT_UI_COUNTER)
});
